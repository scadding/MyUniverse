...
char *texture_name (planet_type type)
{
    ...
    case tUnknown:
        ...
        break;
    case tRock:
        typeString = "callisto.jpg";
        break;
    case tVenusian:
        typeString = "venuslike.jpg";
        break;
    case tTerrestrial:
        typeString = "Earthlike.png";
        break;
    case tSubSubGasGiant:
        typeString = "x.jpg";
        break;
    case tSubGasGiant:
        typeString = "gasgiant.jpg";
        break;
    case tGasGiant:
        typeString = "jupiterlike.jpg";
        break;
    case tMartian:
        typeString = "mars.jpg";
        break;
    case tWater:
        ...
        break;
    case tIce:
        typeString = "pluto.jpg";
        break;
    case tAsteroids:
        typeString = "asteroid.jpg";
        break;
    case t1Face:
        typeString = "x.jpg";
        break;
