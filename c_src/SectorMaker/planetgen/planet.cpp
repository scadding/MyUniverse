...
double planet(double a, double b, double c, double d,       /* altitudes of the 4 verticess */
...
void printppm(FILE *outfile);

void printppmBW(FILE *outfile);
...
void printxpm(FILE *outfile);

void printxpmBW(FILE *outfile);

void printheights(FILE *outfile);
...
void conical()
{
    double k1,c,y2,x,y,zz,theta1,theta2,ymin,ymax,cos2;
    int i,j;
