...
int cloudiness;
	...
	switch(tolower(argv[1][1]))
	{
           ...
           case 's' : printf("Small World (200km) Surface gravity of .024 G. \n");
                      break;

           case '1' : printf("Small world. Surface gravity of .122 G. \n");
                      break;

		case '2' : printf("Small world. Surface gravity of .24 G. \n");
                      break;

		case '3' : printf("Small world. Surface gravity of .37 G.\n");
                      break;

		case '4' : printf("Small world. Surface gravity of .5 G. \n");
                      break;

		case '5' : printf("Medium sized world. Surface gravity of .625 G. \n");
                      break;

		case '6' : printf("Medium sized world. Surface gravity of .84 G. \n");
                      break;

		case '7' : printf("Medium sized world. Surface gravity of .875 G. \n");
                      break;
	...
	switch(tolower(argv[1][2]))
	{
           ...
           case 'e' : printf("The world's surface is ellipsoidal, not spherical in shape.\n");
	...
	switch(tolower(argv[1][4]))
	{
     ...
     switch(tolower(argv[1][5]))
     {
		...
		case '7' : printf("Balkanization. No central ruling authority exists; rival governments compete\n");
                      printf("for control.\n");
                      break;
		...
		case '9' : printf("Impersonal Bureaucracy. Government by agencies that are insulated from\n");
                      printf("the governed.\n");
                      break;
	...
	switch(tolower(argv[1][6]))
	{
		...
		case '3' : printf("Weapons of a strict military nature (machine guns,\n");
