...
int dir;
{
    ...
    case DOWN:
        ...
        break;
    default:
        fatal_error("opposite_direction(): unknown direction");
    }
...
int dir;
{
    ...
    case WEST:
        ...
        break;
    default:
        fatal_error("left_direction(): unknown direction");
    }
...
int dir;
{
    ...
    case WEST:
        ...
        break;
    default:
        fatal_error("right_direction(): unknown direction");
    }
        ...
        while (room != NULL) {
            if (room->level == lvl) {
                ...
                case ROOM:
                    ...
                    break;
                case CHAMBER:
                    fprintf(outfile, "%%chamber\n");
                    break;
                case PASSAGE:
                    fprintf(outfile, "%%passage\n");
                    break;
                case STAIRWAY:
                    fprintf(outfile, "%%stairway\n");
                    break;
                case JUNCTION:
                    fprintf(outfile, "%%junction\n");
                    break;
                }
