                     ...
                     boolean multiple)
{
    ...
    case 'A':
        ...
        break;
    case 'G':
        pl->diameter = 10000.0*(double)dice(3, 6);
        break;
    case 'R':
        pl->diameter = 1000.0*(double)randint(1, 10);
        break;
    case 'J':
        pl->diameter = 1000.0*(double)randint(1, 10);
        break;
    case 'D':
        pl->diameter = 1000.0*(double)(dice(2, 6) + 2);
        break;
    case 'H':
        pl->diameter = 1000.0*(double)(dice(3, 6) + 1);
        break;
    case 'M':
        pl->diameter = 1000.0*(double)(dice(2, 6) + 5);
        break;
    case 'E':
        pl->diameter = 1000.0*(double)(dice(2, 6) + 5);
        break;
    ...
    while (*cp && isgraph(*cp)) {
        ...
        if (this_alnum) {
            ...
            if (isalpha(*cp)) {
                switch (*cp) {
                case 'c':
                    starlist[stars - 1].spcode = 100;
                    break;
                case 'g':
                    starlist[stars - 1].spcode = 300;
                    break;
                case 'D':
                    starlist[stars - 1].spcode = 700;
                    break;
                case 'n':
                    starlist[stars - 1].spcode = 800;
                    break;
                case 'b':
                    starlist[stars - 1].spcode = 900;
                    break;
                case 'B':
                    starlist[stars - 1].spcode += 10;
                    break;
                case 'A':
                    starlist[stars - 1].spcode += 20;
                    break;
                case 'F':
                    starlist[stars - 1].spcode += 30;
                    break;
                case 'G':
                    starlist[stars - 1].spcode += 40;
                    break;
                case 'K':
                    starlist[stars - 1].spcode += 50;
                    break;
                case 'M':
                    starlist[stars - 1].spcode += 60;
                    break;
                default:
                    break;
                }
