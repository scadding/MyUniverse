...
static PrimStarTypeRoll;
static PrimLumClassRoll;
...
double PlanetVolume(double diameter, char dense)
{
    ...
    switch (dense)
    {
        case 'L': return(V*0.55); break;
        case 'A': return(V); break;
        case 'H': return(V*1.55); break;
    }
    return (V);
...
char ChartPrimStarType ()
{
    ...
    switch (dieroll)
    {
      ...
      default: printf("Star Type Error %d\n", dieroll);   break;
    }
...
char ChartPrimLumClass(char StarType)
{
    ...
    switch (dieroll)
    {
      ...
      default: printf("Lumm Class Error %d\n", dieroll);   break;
    }
...
char ChartDecClass (char StarType, char LumClass)
{
    ...
    switch (dieroll)
    {
      ...
      default: printf("Dec Class Error %d\n", dieroll);   break;
    }
...
double ChartStellarMass (char StarType, char DecClass, char LumClass)
{
    ...
    switch (StarType)
    {
      case 'O': StarSize = 0; break;
      case 'B': StarSize = 0; break;
      case 'A': StarSize = 2; break;
      case 'F': StarSize = 4; break;
      case 'G': StarSize = 6; break;
      case 'K': StarSize = 8; break;
      case 'M': StarSize = 10; break;
    }
...
short ChartComOrbit()
{
    ...
    switch (dieroll)
    {
      ...
      case 7:   return(4+d6()); break;
      case 8:   return(5+d6()); break;
      case 9:   return(6+d6()); break;
      case 10:  return(7+d6()); break;
      case 11:  return(8+d6()); break;
      case 12:  return(99); break;
      default: printf("Dec Class Error %d\n", dieroll);   break;
    }
...
double ChartSatOrbit()
{
    ...
    else if (dieroll < 12)
    {
      switch (d6()+d6())
      {
        ...
        case 9:   return(50); break;
        case 10:  return(55); break;
        case 11:  return(60); break;
    ...
    else    
    {
      switch (d6()+d6())
      {
        ...
        case 9:   return(250); break;
        case 10:  return(275); break;
        case 11:  return(300); break;
        case 12:  return(325); break;
      }
    }
...
double ChartOrbitRange(short orbitnum)
{
  ...
  switch (orbitnum)
  {
    case 0 :  r =     0.1 + Change(    0.1); break; /* 0.2 */
    case 1 :  r =     0.3 + Change(    0.1); break; /* 0.4 */
    case 2 :  r =     0.6 + Change(    0.1); break; /* 0.7 */
    case 3 :  r =     0.8 + Change(    0.2); break; /* 1.0 */
    case 4 :  r =     1.2 + Change(    0.4); break; /* 1.6 */
    case 5 :  r =     2.0 + Change(    0.8); break; /* 2.8 */
    case 6 :  r =     3.6 + Change(    1.6); break; /* 5.2 */
    case 7 :  r =     6.8 + Change(    3.2); break; /* 10.0 */
    case 8 :  r =    13.2 + Change(    6.4); break; /* 19.6 */
    case 9 :  r =    26.0 + Change(   12.8); break; /* 38.8 */
    case 10 : r =    51.6 + Change(   25.6); break; /* 77.2 */
    case 11 : r =   102.8 + Change(   51.2); break; /* 154.0 */
    case 12 : r =   205.2 + Change(  102.4); break; /* 307.6 */
    case 13 : r =   410.0 + Change(  204.8); break; /* 614.8 */
    case 14 : r =   819.6 + Change(  409.6); break; /* 1229.2 */
    case 15 : r =  1638.8 + Change(  819.2); break; /* 2548.0 */
    case 16 : r =  3277.2 + Change( 1638.4); break; /* 4915.6 */
    case 17 : r =  6554.0 + Change( 3276.8); break; /* 9830.8 */
    case 18 : r = 13107.6 + Change( 6553.6); break; /* 19661.2 */
    case 19 : r = 26214.8 + Change(13107.2); break; /* 39322.0 */
    default: printf("Orbit Number Error %d\n", orbitnum);   break;
  }
  return (r);
...
char ChartNumGasGiants()
{
    ...
    switch (dieroll)
    {
      ...
      case 11: return(5); break;
      case 12: return(5); break;
      default: printf("Number Of GG Error %d\n", dieroll);   break;
    }
} /* end of NumGasGiants */
...
double ChartOrbitEcc()
{
    ...
    switch (dieroll)
    {
      ...
      case 8: return(0.005); break;
      case 9: return(0.010); break;
      case 10: return(0.015); break;
      case 11: return(0.020); break;
      default:
        dieroll = d6()+d6();
    
        switch (dieroll)
        {
          case 1: return(0.025); break;
          case 2: return(0.050); break;
          case 3: return(0.100); break;
          case 4: return(0.200); break;
          case 5: return(0.250); break;
          default:
            return(0.300); break;
        }
      break;
...
double ChartAxialTilt()
{
    ...
    {
      case 2:
      case 3: return(-1.0 + d10());
        break;
      case 4:
      case 5: return(9.0 + d10()); 
        break;
      case 6:
      case 7: return(19.0 + d10());
        break;
      case 8:
      case 9: return(20.0 + d10());
        break;
      case 10:
      case 11: return(29.0 + d10());
        break;
      default:
        dieroll = d6();
        ...
        {
          case 1:
          case 2: return(49 + d10());
            break;
          case 3: return(59 + d10());
            break;
          case 4: return(69 + d10());
            break;
          case 5: return(79 + d10());
            break;
...
double PrintPlanet (char orbit, double range, Planet *p)
{
    ...
    switch (p->size)
    {
      case 0:  printf("Very Small "); X =   200 + Change(300); break;
      case 1:  printf("Small      "); X =   800 + Change(800); break;
      case 2:  printf("Small      "); X =  2400 + Change(1600); break;
      case 3:  printf("Small      "); X =  4000 + Change(800); break;
      case 4:  printf("Small      "); X =  5600 + Change(800); break;
      case 5:  printf("Medium     "); X =  7200 + Change(800); break;
      case 6:  printf("Medium     "); X =  8800 + Change(800); break;
      case 7:  printf("Medium     "); X = 10400 + Change(800); break;
      case 8:  printf("Large      "); X = 12000 + Change(800); break;
      case 9:  printf("Large      "); X = 13600 + Change(800); break;
      case 10: printf("Large      "); X = 15200 + Change(800); break;
    }
    PlanetDiam = X;
    ...
    switch (p->dense)
    {
        case 'L': printf("Low Density    "); break;
        case 'A': printf("Average Density"); break;
        case 'H': printf("High Density   "); break;
    }
    ...
    switch (p->atmosphere)
    {
      case 0:  printf("Vacuum       "); X = 0; break;
      case 1:  printf("Vacumm       "); X = 0.00 + Change(0.01); break;
      case 2:  printf("Very Thin (t)"); X = 0.10 + Change(0.16); break;
      case 3:  printf("Very Thin    "); X = 0.10 + Change(0.16); break;
      case 4:  printf("Thin (taint) "); X = 0.42 + Change(0.14); break;
      case 5:  printf("Thin         "); X = 0.42 + Change(0.14); break;
      case 6:  printf("Standard     "); X = 0.70 + Change(0.40); break;
      case 7:  printf("Standard (t) "); X = 0.70 + Change(0.40); break;
      case 8:  printf("Dense        "); X = 1.50 + Change(0.50); break;
      case 9:  printf("Dense (taint)"); X = 1.50 + Change(0.50); break;
      case 10: printf("Exotic       "); X = 0    + Change(3.00); break;
      case 11: printf("Corrosive    "); X = 0    + Change(3.00); break;
      case 12: printf("Insidious    "); X = 0    + Change(3.00); break;
      default: printf("Exotic       "); X = 0    + Change(3.00); break;
    }
    ...
    switch (p->hydro)
    {
      ...
      case 1:  printf("Dry World   "); break;
      case 2:  printf("Dry World   "); break;
      case 3:  printf("Wet (30%%)   "); break;
      case 4:  printf("Wet (40%%)   "); break;
      case 5:  printf("Wet (50%%)   "); break;
      case 6:  printf("Wet (60%%)   "); break;
      case 7:  printf("Wet (70%%)   "); break;
      case 8:  printf("Wet (80%%)   "); break;
      case 9:  printf("Wet (90%%)   "); break;
      default: printf("Water World "); break;
    }
    ...
    switch (p->maxpop)
    {
      ...
      case 1:  printf("Very Poor"); break;
      case 2:  printf("Very Poor"); break;
      case 3:  printf("Very Poor"); break;
      case 4:  printf("Very Poor"); break;
      case 5:  printf("Poor     "); break;
      case 6:  printf("Poor     "); break;
      case 7:  printf("Good     "); break;
      case 8:  printf("Good     "); break;
      case 9:  printf("Habitable"); break;
      default: printf("Habitable"); break;
    }
