...
class generator(object):
    ...
    def adj3(self):
        elements = ["battered", "broken", "cracked", "dusty", "empty", "heavy", "rusty", "satin", "shattered", "shimmering", "shiny", "stolen", "tarnished", "weathered"]
        return choice(elements)
